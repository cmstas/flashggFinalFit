...
make_toys(){
	...
	#python makeToysHH.py --inputWSFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --ext $tag --dryRun --nToys $nToys
        python makeToysHH.py --inputWSFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/unblind/step2/round2/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --ext $tag --dryRun --nToys $nToys --loadSnapshot MultiDimFit #--dropResonantBkg ##loadsnapshot means postfit
        iter=0
        while [ $iter -lt $nToys ]
        do 
...
make_SpB(){
#    pushd Plots
        #python makeSplusBModelPlot.py --inputWSFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --inputSpecialFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --cat "cat0" --doBands --ext $tag --unblind # --parameterMap "singleH:1,doubleH:1"
        python makeSplusBModelPlot.py --inputWSFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/unblind/step2/round2/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --inputSpecialFile /home/users/yagu/XYH/XtoYH_sys/plots_2023-12-19_CategorizationAndPreselSFCorrected/CMSSW_10_2_13/src/flashggFinalFit/unblind/step2/round2/higgsCombine_MultiDimFit_r_ggbbres_mx280my90mh90.MultiDimFit.mH90.root --cat "cat1" --doBands --ext $tag --unblind --loadSnapshot MultiDimFit # --parameterMap "singleH:1,doubleH:1"
