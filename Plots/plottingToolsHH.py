...
def makeSplusBPlot(workspace,hD,hSB,hB,hS,hNR,hDr,hBr,hSr,cat,options,dB=None,reduceRange=None,limit=None):
  ...
  if options.doBands:
    ...
    gr_2sig.SetFillColor(ROOT.TColor.GetColor("#85D1FBff"))
    gr_2sig.SetFillStyle(1001)
    gr_1sig_r.SetFillColor(ROOT.TColor.GetColor("#FFDF7Fff"))
    gr_1sig_r.SetFillStyle(1001)
    gr_2sig_r.SetFillColor(ROOT.TColor.GetColor("#85D1FBff"))
