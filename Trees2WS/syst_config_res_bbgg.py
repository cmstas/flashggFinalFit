...
trees2wsCfg = {
  ...
  'mainVars':["CMS_hgg_mass","weight","dZ", "*sigma*"], # Var for the nominal RooDataSets
  ...
  'systematics':["fnuf","material","JER", "JES", "MET_JER", "MET_JES", "MET_Unclustered", "MCScale_scale", "MCSmear_smear" ],
