...
# Plotting
print "\n --> Plotting envelope"
tryMake("/home/users/yagu/XYH/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/Background/plots")
tryMake("/home/users/yagu/XYH/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/Background/plots/%s"%opt.year)
plotPdfMap(model,model.envelopePdfs,opt.plotBlindingRegion,_outdir="/home/users/yagu/XYH/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/Background/plots/%s"%opt.year,_cat=opt.cat)
if model.xvar.getMax() > 180: #if high mass
  plotPdfMap(model,model.envelopePdfs,opt.plotBlindingRegion,_outdir="/home/users/yagu/XYH/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/Background/plots/%s"%opt.year,_cat=opt.cat,setLogY=True)
