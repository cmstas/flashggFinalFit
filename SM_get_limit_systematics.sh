...
syst_plots(){
    pushd Combine
        ...
        #combineTool.py -M Impacts -d Datacard.root -m 125.38 -t -1 --setParameters r=$central_limit --redefineSignalPOI r --autoMaxPOIs "r" --rMin -10 --rMax 200 --squareDistPoiStep  --freezeParameters MH --doInitialFit --robustHesse 1 --robustFit 1  --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2
        #combineTool.py -M Impacts -d Datacard.root -m 125.38 -t -1 --setParameters r=$central_limit --redefineSignalPOI r --autoMaxPOIs "r" --rMin -10 --rMax 200 --squareDistPoiStep  --freezeParameters MH --doFits       --robustHesse 1 --robustFit 1  --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 --parallel 10 
        #rm impacts.json
        #combineTool.py -M Impacts -d Datacard.root -m 125.38 -t -1 --setParameters r=$central_limit --redefineSignalPOI r --autoMaxPOIs "r" --rMin -10 --rMax 200 --squareDistPoiStep  --freezeParameters MH -o impacts.json --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2
        ...
        # Impacts
        #combine-M Impacts -d Datacard.root -m 125.38 --redefineSignalPOI r --autoMaxPOIs "r" --rMin 1 --rMax 200 --squareDistPoiStep  --freezeParameters MH --doInitialFit --robustHesse 1 --robustFit 1  --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2
        #combine-M Impacts -d Datacard.root -m 125.38 --redefineSignalPOI r --autoMaxPOIs "r" --rMin 1 --rMax 200 --squareDistPoiStep  --freezeParameters MH --doFits       --robustHesse 1 --robustFit 1  --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 --parallel 10 
        #rm impacts.json
        #combine-M Impacts -d Datacard.root -m 125.38 --redefineSignalPOI r --autoMaxPOIs "r" --rMin 1 --rMax 200 --squareDistPoiStep  --freezeParameters MH -o impacts.json --cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2
	...
	#cp impacts.pdf /home/users/iareed/public_html/ttHH/flashggFinalFit/$tag/impacts_partial_unblind.pdf
    popd	
}
