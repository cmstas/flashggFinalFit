...
sig_model=/home/users/yagu/XYH/XtoYH_pNN/Interpolation_forIan/
res_bkg_model=/home/users/yagu/XYH/XtoYH_pNN/Outputs_forIan/Graviton/ResonantBkg
...
pushd SignalModelInterpolation
  ...
  python create_signal_ws_new_cat_2d_res_bkg.py -i $res_bkg_model -o res_bkg_outdir --mgg-range $mggl $mggh
  # if [[ -n $do_dy_bkg ]]; then 
