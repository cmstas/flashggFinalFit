...
pushd Combine  
  ...
  # combineTool.py -t -1 --redefineSignalPOI r --cminDefaultMinimizerStrategy 0 -M Impacts -m ${mh} -d Datacard_ggtt_resonant_${m}_ggtt_resonant.root --freezeParameters MH,MX,MY --setParameters MX=${mx},MY=${my},r=${exp_limit}${index_values} --doInitialFit -n ${mo}
  # combineTool.py -t -1 --redefineSignalPOI r --cminDefaultMinimizerStrategy 0 -M Impacts -m ${mh} -d Datacard_ggtt_resonant_${m}_ggtt_resonant.root --freezeParameters MH,MX,MY --setParameters MX=${mx},MY=${my},r=${exp_limit}${index_values} --doFits --parallel 8 -n ${mo}
