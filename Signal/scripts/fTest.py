...
def get_options():
  ...
  parser.add_option('--mass', dest='mass', default='125.38', help="Mass point to fit")
...
for proc in opt.procs.split(","):
  ...
  d = reduceDataset(inputWS.data("%s_%s_%s_%s"%(procToData(proc.split("_201")[0]),opt.mass,sqrts__,opt.cat)),aset)
