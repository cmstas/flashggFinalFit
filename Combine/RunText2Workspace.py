...
print(opt.mode,opt.ext,opt.tag)
print("text2workspace.py Datacard%s_%s.txt -o Datacard%s_%s.root %s %s"%(opt.ext,opt.tag,opt.ext,opt.mode,opt.common_opts,models[opt.mode]))
